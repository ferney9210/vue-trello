...
export default {
  ...
  // ferch de las listas de un determinado panel 
  ...
  // fetch de las tareas corespondientes a una lista
  ...
  [types.FETCH_TASKS_SUCCESS] (state, { tasks }) {
    state.fetchingData = false
    state.error = null 
    state.tasks = objet.assing({}, state.tasks, tasks)
  },
  ...
  [ types.ADD_TASK] (state, { task }) {
    Vue.set(state.stasks, task.id, task)
  },
